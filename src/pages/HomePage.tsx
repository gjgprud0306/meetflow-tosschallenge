...
function ChatComposer() {
  return (
    <div className="flex h-[104px] w-[1168px] shrink-0 items-center gap-[34px] bg-white px-8 py-4">
      <div className="flex h-12 w-[702px] items-center rounded-lg border border-[#E0E4EB] bg-[#F9FAFB]/80 px-4">
...
export function HomePage() {
  return (
    <MeetFlowLayout bottomBar={<ChatComposer />}>
      <div className="h-[823px] w-full px-8 pt-7">
